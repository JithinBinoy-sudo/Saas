...
def run_arima_forecast(points: list[dict]) -> dict | None:
    """
    Fit ARIMA on the given monthly data points and return a 1-month-ahead forecast.
    ...
    try:
        ...
        return {
            ...
            "predicted_revenue": max(0, float(forecast_mean)),
